 ...
 * sunpos.cpp
 *
 * $Id: sunpos.cpp,v 1.2 2000/06/15 09:43:30 espie Exp $
 *
 ...
 * Bump to what I have
 *
 * Revision 0.1  1998/12/09 18:49:47  thorsten
 * initial revision
 *
 */
 ...
 *
 * RCS $Id: sunpos.cpp,v 1.2 2000/06/15 09:43:30 espie Exp $
 *
 ...
 */
double SunPos::solve_keplers_equation(double M)
{
    double E;
    double delta;
 ...
 * (after duffett-smith, section 47)
 */
double SunPos::sun_ecliptic_longitude(time_t ssue)
 ...
 */
void SunPos::ecliptic_to_equatorial(double lambda, double beta,
 ...
 */
double SunPos::julian_date(int y, int m, int d)
//     int y;                     /* year (e.g. 19xx)          */
 ...
 * directly overhead.
 */
void SunPos::GetSunPos(time_t ssue, double* lat, double* lon)
//     time_t  ssue;              /* seconds since unix epoch */
